"""
Adapted from:
https://github.com/facebookresearch/sam2/blob/main/sam2/modeling/sam/transformer.py
"""
...
class TwoWayTransformer(nn.Module):
    def __init__(
        ...
        Args:
          ...
          input_fmt (str): spatial format for inputs, e.g. "ZYXC" for 3D.
        """
        super().__init__()
    ...
    def forward(
        ...
        if self.input_fmt == "ZYXC":
            ...
            # NOTE: image_pe: [B, C, Z, Y, X] -> [B, Z * Y * X, C]

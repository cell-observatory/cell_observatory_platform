...
class BaseDataElement:
    ...
    on a task, such as predicted bboxes, instance masks, etc.
    ...
    Args:
        metainfo (dict, optional): A dict contains the meta information
            of images, such as ``dict(img_shape=(512, 512, 3),
            scale_factor=(1, 1, 1, 1))``. Defaults to None.
        kwargs (dict, optional): A dict contains annotations of images.
            Defaults to None.
    """
